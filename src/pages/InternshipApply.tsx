...
const InternshipApply = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Reset form and go back to programs
    setFormData({
      name: "",
      email: "",
      phone: "",
  ...
  const renderFormView = () => (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="text-center mb-8">
        <h1 className="responsive-title font-bold mb-4 text-white">
  ...
  return (
    <PageTransition>
      <div className="min-h-screen internship-apply-page-bg">
        <div className="universal-page-overlay" />
        <div className="universal-moving-gradient" />
        <div className="universal-content">
          <Navigation />

          <section className="pt-24 pb-16 px-4 sm:px-6 lg:px-8 bg-transparent">
